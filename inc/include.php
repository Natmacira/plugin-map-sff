...
function map_sff_generate_form()
{
	...
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="category[]" value="Resistance" required>Resistance</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="category[]" value="Refusal">Refusal</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="category[]" value="Both">Both</label>';
	...
	$html .= '<p>' . esc_html__('Tipo de conformación del proyecto', 'map-sff') . ': *</p>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="cultural-group[]" value="Asociaciones Civiles" required>Asociaciones Civiles</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="cultural-group[]" value="Cooperativas">Cooperativas</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="cultural-group[]" value="Productoras">Productoras</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="cultural-group[]" value="ONGs">ONGs</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="cultural-group[]" value="No es una agrupacion">' . esc_html__('No es una agrupación', 'map-sff') . '</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="cultural-group[]" value="Otros">' . esc_html__('Otros', 'map-sff') . '</label>';
	$html .= '<label>' . esc_html__('Otros', 'map-sff') . ': *<br><textarea class="map-sff-form-field" type="text" name="cultural-group-other" value="" required></textarea></label>';

	$html .= '<p>' . esc_html__('Actividades que realizan (podés elegir más de una opción)', 'map-sff') . ': *</p>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="Ciclos" required>Ciclos</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="Fiestas">Fiestas</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="Talleres">Talleres</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="Obras teatrales">Obras teatrales</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="Marchas">Marchas</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="Galerias">Galerias</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="No aplica">' . esc_html__('No aplica', 'map-sff') . '</label>';
	$html .= '<label><input class="map-sff-form-field" type="checkbox" name="other-projects[]" value="Otros">' . esc_html__('Otros', 'map-sff') . '</label>';

	$html .= '<label>' . esc_html__('Otros', 'map-sff') . ': *<br><textarea class="map-sff-form-field" type="text" name="other-projects-other" value="" required></textarea></label>';

	$html .= '<label>' . esc_html__('Ciudad', 'map-sff') . ': *<br><textarea class="map-sff-form-field" type="text" name="city" value="" required></textarea></label>';

	$html .= '<label>' . esc_html__('Provincia', 'map-sff') . ': *<br><textarea class="map-sff-form-field" type="text" name="province" value="" required></textarea></label>';

	$html .= '<label>' . esc_html__('Teléfono', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="phone" value=""></textarea></label>';

	$html .= '<label>' . esc_html__('Sitio web', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="website" value=""></textarea></label>';

	$html .= '<label>' . esc_html__('Facebook', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="facebook" value=""></textarea></label>';

	$html .= '<label>' . esc_html__('Instagram', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="instagram" value=""></textarea></label>';

	$html .= '<label>' . esc_html__('Twitter', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="twitter" value=""></textarea></label>';

	$html .= '<label>' . esc_html__('Youtube', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="youtube" value=""></textarea></label>';

	$html .= '<label>' . esc_html__('Otras redes sociales', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="other-social" value=""></textarea></label>';

	$html .= '<label>' . esc_html__('Código postal', 'map-sff') . ': <br><textarea class="map-sff-form-field" type="text" name="postal-code" value=""></textarea></label>';
